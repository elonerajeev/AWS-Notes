...
This guide mirrors the AWS Notes style, but explains the same cloud concept with **Microsoft Azure** services. It maps **Amazon Machine Images (AMI)** to **Azure Compute Gallery and managed images** and adds Azure-specific design guidance.
...
- **AWS topic:** Amazon Machine Images (AMI)
- **Azure equivalent:** Azure Compute Gallery and managed images
- **Main idea:** Azure Compute Gallery helps standardize VM images, versions, replication, sharing, and regional rollout for repeatable VM deployments.
