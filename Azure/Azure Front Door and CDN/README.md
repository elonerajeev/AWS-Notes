...
This guide mirrors the AWS Notes style, but explains the same cloud concept with **Microsoft Azure** services. It maps **Amazon CloudFront** to **Azure Front Door, Azure CDN, WAF** and adds Azure-specific design guidance.
...
- **Azure equivalent:** Azure Front Door, Azure CDN, WAF
- **Main idea:** Azure Front Door and Azure CDN accelerate web content, route traffic globally, terminate TLS, cache static assets, and protect applications with web application firewall capabilities.
