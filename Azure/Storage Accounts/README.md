...
This guide mirrors the AWS Notes style, but explains the same cloud concept with **Microsoft Azure** services. It maps **Amazon S3** to **Azure Blob Storage, Data Lake Storage, Files, Queues, Tables** and adds Azure-specific design guidance.
...
- **AWS topic:** Amazon S3
- **Azure equivalent:** Azure Blob Storage, Data Lake Storage, Files, Queues, Tables
- **Main idea:** Azure Storage provides durable object, file, queue, and table storage for static websites, backups, logs, data lakes, and application assets.
