...
This guide mirrors the AWS Notes style, but explains the same cloud concept with **Microsoft Azure** services. It maps **Amazon EKS** to **AKS, Azure CNI, Azure Policy, Container Insights** and adds Azure-specific design guidance.
...
- **Azure equivalent:** AKS, Azure CNI, Azure Policy, Container Insights
- **Main idea:** Azure Kubernetes Service is a managed Kubernetes platform for running containerized workloads with Microsoft-managed control plane operations and Azure integrations.
