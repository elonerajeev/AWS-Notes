...
This guide mirrors the AWS Notes style, but explains the same cloud concept with **Microsoft Azure** services. It maps **AWS Lambda** to **Azure Functions, Durable Functions, Event Grid triggers** and adds Azure-specific design guidance.
...
- **Azure equivalent:** Azure Functions, Durable Functions, Event Grid triggers
- **Main idea:** Azure Functions runs event-driven code without managing servers and integrates with HTTP, timers, queues, Event Grid, Service Bus, Cosmos DB, and storage events.
