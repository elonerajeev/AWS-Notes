...
This guide mirrors the AWS Notes style, but explains the same cloud concept with **Microsoft Azure** services. It maps **Amazon EC2** to **Azure Virtual Machines, VM Scale Sets, Azure Compute Gallery** and adds Azure-specific design guidance.
...
- **Azure equivalent:** Azure Virtual Machines, VM Scale Sets, Azure Compute Gallery
- **Main idea:** Azure Virtual Machines provide resizable Windows and Linux compute in the cloud for web apps, legacy systems, development environments, batch jobs, and enterprise workloads.
