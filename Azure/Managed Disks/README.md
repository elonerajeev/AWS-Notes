...
This guide mirrors the AWS Notes style, but explains the same cloud concept with **Microsoft Azure** services. It maps **Amazon EBS** to **Azure Managed Disks, snapshots, shared disks** and adds Azure-specific design guidance.
...
- **Azure equivalent:** Azure Managed Disks, snapshots, shared disks
- **Main idea:** Azure Managed Disks are block-level storage volumes for Azure VMs, providing OS disks, data disks, snapshots, encryption, bursting, and high-performance tiers.
