...
This guide mirrors the AWS Notes style, but explains the same cloud concept with **Microsoft Azure** services. It maps **Amazon RDS** to **Azure SQL Database, SQL Managed Instance, Azure Database for PostgreSQL, Azure Database for MySQL** and adds Azure-specific design guidance.
...
- **Azure equivalent:** Azure SQL Database, SQL Managed Instance, Azure Database for PostgreSQL, Azure Database for MySQL
- **Main idea:** Azure managed database services reduce operational work for relational databases by handling patching, backups, high availability, scaling, and monitoring.
